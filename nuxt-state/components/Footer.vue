<template>
  <div class="footer-min-h flex flex-col">
    <!-- Footer -->
    <footer class="bg-black text-white py-6 mt-auto">
      <div class="container mx-auto px-4">
        <div class="flex flex-wrap justify-between">
          ...
          <div>
            <h2 class="text-xl font-semibold">Contactos</h2>
            <p class="mt-2">Email: contato@exemplo.com</p>
...
//   if (footerTop + footerHeight > viewportHeight) {
//     footer.classList.remove('footer-min-h');
//     footer.classList.add('footer-default');
//   } else {
//     footer.classList.remove('footer-default');
//     footer.classList.add('footer-min-h');
//   }
// }
